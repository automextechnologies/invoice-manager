...
import { downloadInvoice, fetchNextInvoiceNumber } from '../services/api';
...
const InvoiceForm = ({ savedCustomers, selectedCustomerId, onSelectCustomer, companyDetails, qrCode, onQrUpload, savedProducts, navigateTo }) => {
  ...
  const setItems = (updateAction) => {
    setFormData(prev => {
      const newItems = typeof updateAction === 'function' ? updateAction(prev.items) : updateAction;
